...
Run from project root: python scripts/train_ml_with_new_data.py
"""
import os
import sys
import json
...
sys.path.insert(0, os.path.join(PROJECT_ROOT, "Viroai_DataBase", "data_generators"))
sys.path.insert(0, os.path.join(PROJECT_ROOT, "models"))

def check_and_generate_data():
    """Check if processed data exists, generate if needed"""
    processed_dir = os.path.join(PROJECT_ROOT, "Viroai_DataBase", "processed")
...
def generate_accuracy_table():
    ...
    comparison_file = os.path.join(PROJECT_ROOT, "ML_MODULES_ACCURACY_COMPARISON.json")
    ...
    # Save to file
    output_file = os.path.join(PROJECT_ROOT, "ML_ACCURACY_BEFORE_AFTER.md")
